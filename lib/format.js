...
export function scoreTier(score) {
  ...
  if (n >= 54) return { label: "Exceptional", tone: "text-emerald-600 dark:text-emerald-400" };
  if (n >= 46) return { label: "Excellent", tone: "text-emerald-600 dark:text-emerald-400" };
  if (n >= 36) return { label: "Strong", tone: "text-lime-600 dark:text-lime-400" };
  if (n >= 26) return { label: "Decent", tone: "text-amber-600 dark:text-amber-400" };
  if (n >= 14) return { label: "Modest", tone: "text-zinc-500" };
  return { label: "Plain", tone: "text-zinc-400" };
}
